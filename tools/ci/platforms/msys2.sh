...
install_build_tools() {
  ...
  install="arm_clang_toolchain arm_gcc_toolchain arm64_gcc_toolchain esp-tool gen-romfs kconfig_frontends riscv_gcc_toolchain rust xtensa-esp32-gcc-toolchain"
